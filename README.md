...
Objetivo
Crear un programa que recomiende canciones al usuario tomando en cuenta sus géneros musicales favoritos.

Idea del algoritmo
INICIO

Mostrar una lista de géneros musicales.

Preguntar al usuario qué género le gusta.

Revisar las canciones disponibles.

Comparar el género de cada canción con el género elegido.

Si coinciden, guardar la canción como recomendación.
